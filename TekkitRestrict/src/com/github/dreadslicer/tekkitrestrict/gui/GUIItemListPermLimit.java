...
public class GUIItemListPermLimit extends JDialog {
	...
	public GUIItemListPermLimit(JFrame Owner){
		super(Owner,true);
	...
	public void init() {
		...
		btnAdd_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				//TRItem[] gg = TRNoItem.gettRangedItemValues(s);
		...
		lblLimit.setBounds(210, 12, 180, 15);
		contentPane.add(lblLimit);
		
		textField = new JTextField();
		textField.setText("10");
		textField.setColumns(10);
		textField.setBounds(220, 27, 170, 19);
	...
	public void refElem(){
		...
		txtDefault.setText(resultName);
		textField.setText(this.resultLimit);
	}
}

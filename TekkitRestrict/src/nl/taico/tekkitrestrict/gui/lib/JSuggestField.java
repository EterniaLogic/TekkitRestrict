...
public class JSuggestField extends JTextField {
	...
	public Vector<String> suggestions;
	private LinkedHashMap<String, TRItem> data2;
	...
	public JSuggestField(Frame owner) {
		...
		data2 = new LinkedHashMap<String, TRItem>();
	...
	public JSuggestField(Frame owner, LinkedHashMap<String, TRItem> data) {
		this(owner);
		this.data2 = data;
		setSuggestData(new Vector<String>(data.keySet()));
	}
	...
	public boolean setSuggestData(LinkedHashMap<String, TRItem> data) {
		if (data == null) {
			return false;
		}
		this.data2 = data;
		Vector<String> temp = new Vector<String>(data.keySet());
	...
	public String getSelectedType(){
		TRItem it = data2.get(this.getText());
		
		if (it.data == -10) return ""+it.id+":0";
		else if (it.data == -1) return ""+it.id;
		else return ""+it.id+":"+it.data;
	}

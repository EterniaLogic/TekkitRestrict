...
public class SettingsStorage_Old {
	...
	public static Config advancedConfig2 = Config.getNewConfig(TekkitRestrict.instance.getLogger(), TekkitRestrict.instance.getDataFolder(), "Advanced.yml");
	public static Config bannedConfig2 = Config.getNewConfig(TekkitRestrict.instance.getLogger(), TekkitRestrict.instance.getDataFolder(), "Banned.yml");
	public static Config databaseConfig2 = Config.getNewConfig(TekkitRestrict.instance.getLogger(), TekkitRestrict.instance.getDataFolder(), "Database.yml");
	public static Config generalConfig2 = Config.getNewConfig(TekkitRestrict.instance.getLogger(), TekkitRestrict.instance.getDataFolder(), "General.yml");
	public static Config groupPermsConfig2 = Config.getNewConfig(TekkitRestrict.instance.getLogger(), TekkitRestrict.instance.getDataFolder(), "GroupPermissions.yml");
	public static Config hackDupeConfig2 = Config.getNewConfig(TekkitRestrict.instance.getLogger(), TekkitRestrict.instance.getDataFolder(), "HackDupe.yml");
	public static Config limitedCreativeConfig2 = Config.getNewConfig(TekkitRestrict.instance.getLogger(), TekkitRestrict.instance.getDataFolder(), "LimitedCreative.yml");
	public static Config limiterConfig2 = Config.getNewConfig(TekkitRestrict.instance.getLogger(), TekkitRestrict.instance.getDataFolder(), "Limiter.yml");
	public static Config loggingConfig2 = Config.getNewConfig(TekkitRestrict.instance.getLogger(), TekkitRestrict.instance.getDataFolder(), "Logging.yml");
	public static Config modModificationsConfig2 = Config.getNewConfig(TekkitRestrict.instance.getLogger(), TekkitRestrict.instance.getDataFolder(), "ModModifications.yml");
	public static Config performanceConfig2 = Config.getNewConfig(TekkitRestrict.instance.getLogger(), TekkitRestrict.instance.getDataFolder(), "Performance.yml");
	public static Config safeZoneConfig2 = Config.getNewConfig(TekkitRestrict.instance.getLogger(), TekkitRestrict.instance.getDataFolder(), "SafeZones.yml");
	public static Config unloadConfig2 = Config.getNewConfig(TekkitRestrict.instance.getLogger(), TekkitRestrict.instance.getDataFolder(), "ChunkUnloader.yml");
	...
	public static void reloadConfigs(){
		advancedConfig2.reloadConfig();
		bannedConfig2.reloadConfig();
		databaseConfig2.reloadConfig();
		generalConfig2.reloadConfig();
		groupPermsConfig2.reloadConfig();
		hackDupeConfig2.reloadConfig();
		limitedCreativeConfig2.reloadConfig();
		limiterConfig2.reloadConfig();
		loggingConfig2.reloadConfig();
		modModificationsConfig2.reloadConfig();
		performanceConfig2.reloadConfig();
		safeZoneConfig2.reloadConfig();
		unloadConfig2.reloadConfig();
	...
	public static void genBanned(){
		...
		}
		{
			final String[] comment = {
				...
				"- \"27562 right\"                    Prevent right click (in the air and on blocks)",
				"- \"27562 both\"                     Prevent left and right click (in the air and on blocks)",
				"- \"27562 trample\"                  Prevent trampling while holding this item",
				"- \"27562 all\"                      Prevent clicking and trampling with this item",
				"                                   (in the air and on blocks)",
				"- \"27562 left safezone\"            Prevent left-clicking with this item in a safezone",
				"                                   (in the air and on blocks)",
				"- \"27562 safezone\"                 Prevent clicking with this item in a safezone",
				"                                   (in the air and on blocks)",
				"- \"27562 right air\"                Prevent right-clicking with this item in the air",
				"- \"27562 both block\"               Prevent clicking with this item on a block",
				"- \"27562 all air safezone\"         Prevents clicking and trampling in the air in a safezone.",
	...
	public static void genGeneral(){
		...
		{
			final String[] comment = new String[] {
				"Attempts to fix the wrench unlocking protected items, bypassing the limiter, and more.",
				"Default: true"
			};
			generalConfig.set("UseWrenchFix", true, comment);
		}
		{
			final String[] comment = new String[] {
				"Attempts to fix tile entity errors by catching error messages from the console and fixing the",
				"block at the coordinates in that error.",
				"Default: true"
			};
			generalConfig.set("TryFixTileEntityErrors", true, comment);
		}
		{
			final String[] comment = new String[] {
		...
		}
		{
			...
			generalConfig.set("ConfigVersion", 3.1d, comment);
		}

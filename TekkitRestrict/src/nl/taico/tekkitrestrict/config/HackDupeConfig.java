...
public class HackDupeConfig extends TRConfig {
	public static ArrayList<String> defaultContents(boolean extra){
		...
		tbr.add("        Broadcast: true");
		if (extra) tbr.add("#:-;-:# Anti-Dupes.TeleportDupe.Broadcast");
		tbr.add("        Kick: false");
		if (extra) tbr.add("#:-;-:# Anti-Dupes.TeleportDupe.Kick");
		tbr.add("        ExecuteCommand:");
		tbr.add("            Enabled: false");
		if (extra) tbr.add("#:-;-:# Anti-Dupes.TeleportDupe.ExecuteCommand.Enabled");
		tbr.add("            Command: \"\"");
		if (extra) tbr.add("#:-;-:# Anti-Dupes.TeleportDupe.ExecuteCommand.Command");
		tbr.add("            TriggerAfter: 1");
		if (extra) tbr.add("#:-;-:# Anti-Dupes.TeleportDupe.ExecuteCommand.TriggerAfter");

...
public class TRConfigManager {
	...
	public TRConfigManager(){
		...
		TRGeneralConfig = manager.getNewConfig("General.config.yml", null, 64);
		TRGeneralConfig.set("PatchComputerCraft", false);
		/*
		String[] comments = {
		...
		comments = new String[] {
			"Change the lowest possible time for RedPower Timers to the value set in ModModifications.config.yml",
			"Default: true"
		};

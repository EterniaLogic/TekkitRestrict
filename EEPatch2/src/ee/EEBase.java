...
public class EEBase
{
  ...
  {
    return ((HashMap)playerItemCharging.get(var0)).get(var1) == null ? false : playerItemCharging.get(var0) == null ? false : ((Boolean)((HashMap)playerItemCharging.get(var0)).get(var1)).booleanValue();
  }
  ...
  public static void updatePlayerEffect(Item var0, int var1, EntityHuman var2)
  {
    ...
    if (playerEffectDurations.get(var2) != null)
    {
      var3 = (HashMap)playerEffectDurations.get(var2);
    }

    var3.put(var0, Integer.valueOf(var1));
  ...
  {
	  try{
		  return ((HashMap)playerEffectDurations.get(var1)).get(var0) == null ? 0 : playerEffectDurations.get(var1) == null ? 0 : ((Integer)((HashMap)playerEffectDurations.get(var1)).get(var0)).intValue();
	  }
  ...
  public static int getPlayerToggleCooldown(EntityHuman var0)
  {
    ...
    return ((Integer)playerToggleCooldown.get(var0)).intValue();
  }
  ...
  public static void updatePlayerToggleCooldown(EntityHuman var0)
  {
    ...
    {
      playerToggleCooldown.put(var0, Integer.valueOf(((Integer)playerToggleCooldown.get(var0)).intValue() - 1));
    }
  }
  ...
  public static int getBuildMode(EntityHuman var0)
  {
    ...
    return ((Integer)playerBuildMode.get(var0)).intValue();
  }
  ...
  public static void updateBuildMode(EntityHuman var0)
  {
    ...
    else if (((Integer)playerBuildMode.get(var0)).intValue() == 3)
    {
      playerBuildMode.put(var0, Integer.valueOf(0));
    }
    else
    {
      playerBuildMode.put(var0, Integer.valueOf(((Integer)playerBuildMode.get(var0)).intValue() + 1));
    }

    if (((Integer)playerBuildMode.get(var0)).intValue() == 0)
    {
      var0.a("Mercurial Extension mode.");
    }
    else if (((Integer)playerBuildMode.get(var0)).intValue() == 1)
    {
      var0.a("Mercurial Creation mode.");
    }
    else if (((Integer)playerBuildMode.get(var0)).intValue() == 2)
    {
  ...
  public static boolean getPlayerArmorOffensive(EntityHuman var0)
  {
    ...
    try{
    	return ((Boolean)playerArmorOffensiveToggle.get(var0)).booleanValue();
	}
  ...
  public static void updatePlayerArmorOffensive(EntityHuman var0, boolean var1)
  {
    ...
    {
      playerArmorOffensiveToggle.put(var0, Boolean.valueOf(!((Boolean)playerArmorOffensiveToggle.get(var0)).booleanValue()));
    }

    if (((Boolean)playerArmorOffensiveToggle.get(var0)).booleanValue())
    {
      if (var1)
      {
  ...
  public static boolean getPlayerArmorMovement(EntityHuman var0)
  {
    ...
    try{
    	return ((Boolean)playerArmorMovementToggle.get(var0)).booleanValue();
    }
    catch(Exception e){ return false; }
  }
  ...
  public static void updatePlayerArmorMovement(EntityHuman var0, boolean var1)
  {
    ...
    {
      playerArmorMovementToggle.put(var0, Boolean.valueOf(!((Boolean)playerArmorMovementToggle.get(var0)).booleanValue()));
    }

    if (((Boolean)playerArmorMovementToggle.get(var0)).booleanValue())
    {
      if (var1)
      {
  ...
  {
	Object gg = playerHammerMode.get(var0); 
    if (gg == null)
    {
    ...
    return ((Boolean)gg).booleanValue();
  }
  ...
  public static void updateHammerMode(EntityHuman var0, boolean var1)
  {
    ...
    {
      playerHammerMode.put(var0, Boolean.valueOf(!((Boolean)playerHammerMode.get(var0)).booleanValue()));
    }

    if (((Boolean)playerHammerMode.get(var0)).booleanValue())
    {
      if (var1)
      {
  ...
  public static boolean getSwordMode(EntityHuman var0)
  {
    ...
    try{
    	return ((Boolean)playerSwordMode.get(var0)).booleanValue();
    }
    catch(Exception e){return false;}
  }
  ...
  public static void updateSwordMode(EntityHuman var0)
  {
    ...
    {
      playerSwordMode.put(var0, Boolean.valueOf(!((Boolean)playerSwordMode.get(var0)).booleanValue()));
    }

    if (((Boolean)playerSwordMode.get(var0)).booleanValue())
    {
  ...
  public static int getWatchCycle(EntityHuman var0)
  {
    ...
    return ((Integer)playerWatchCycle.get(var0)).intValue();
  }
  ...
  public static void updateWatchCycle(EntityHuman var0)
  {
    ...
    else if (((Integer)playerWatchCycle.get(var0)).intValue() == 2)
    {
      playerWatchCycle.put(var0, Integer.valueOf(0));
    }
    else
    {
      playerWatchCycle.put(var0, Integer.valueOf(((Integer)playerWatchCycle.get(var0)).intValue() + 1));
    }

    if (((Integer)playerWatchCycle.get(var0)).intValue() == 0)
    {
      var0.a("Sun-scroll is off.");
    }

    if (((Integer)playerWatchCycle.get(var0)).intValue() == 1)
    {
      var0.a("Sun-scrolling forward.");
    }

    if (((Integer)playerWatchCycle.get(var0)).intValue() == 2)
    {
  ...
  public static int getToolMode(EntityHuman var0)
  {
    ...
    return ((Integer)playerToolMode.get(var0)).intValue();
  }
  ...
  public static void updateToolMode(EntityHuman var0)
  {
    ...
    else if (((Integer)playerToolMode.get(var0)).intValue() == 3)
    {
      playerToolMode.put(var0, Integer.valueOf(0));
    }
    else
    {
      playerToolMode.put(var0, Integer.valueOf(((Integer)playerToolMode.get(var0)).intValue() + 1));
    }

    if (((Integer)playerToolMode.get(var0)).intValue() == 0)
    {
      var0.a("Tool set to normal.");
    }

    if (((Integer)playerToolMode.get(var0)).intValue() == 1)
    {
      var0.a("Tool set to tall-shot.");
    }

    if (((Integer)playerToolMode.get(var0)).intValue() == 2)
    {
      var0.a("Tool set to wide-shot.");
    }

    if (((Integer)playerToolMode.get(var0)).intValue() == 3)
    {
  ...
  public static boolean isPlayerInLava(EntityHuman var0)
  {
    ...
    return ((Boolean)playerInLava.get(var0)).booleanValue();
  }
  ...
  public static boolean isPlayerInWater(EntityHuman var0)
  {
    ...
    return ((Boolean)playerInWater.get(var0)).booleanValue();
  }
  ...
  public static void addPedestalCoords(TilePedestal var0)
  {
    ...
    for ( ; pedestalCoords.get(Integer.valueOf(var1)) != null; var1++);
    pedestalCoords.put(Integer.valueOf(var1), var2);
  ...
  public static void validatePedestalCoords(World var0)
  {
    for (int var1 = 0; var1 < pedestalCoords.size(); var1++)
    {
      ...
      {
        Integer[] var2 = (Integer[])pedestalCoords.get(Integer.valueOf(var1));
        ...
        else
        {
          for (int var3 = 0; var3 < pedestalCoords.size(); var3++)
          {
            ...
            {
              Integer[] var4 = (Integer[])pedestalCoords.get(Integer.valueOf(var3));
  ...
  public static boolean isLeftClickDown(EntityHuman var0, MinecraftServer var1)
  {
    ...
    return ((Boolean)playerLeftClick.get(var0)).booleanValue();
  }
  ...
  public static Boolean getTransGridOpen(EntityHuman var0)
  {
    ...
    return (Boolean)playerTransGridOpen.get(var0);
  }

...
// Source File Name:   ItemDarkHammer.java
...
public class ItemDarkHammer extends ItemDarkTool
{
    ...
    public void doMegaImpact(EntityHuman var1, ItemStack var2, int var3, int var4, int var5, double var6)
    {
        ...
        for(int var8 = -1; var8 <= 1; var8++)
        {
            for(int var9 = -1; var9 <= 1; var9++)
            {
                ...
                if(var8 != 0 || var9 != 0)
                {
                    ...
                    int var13 = world.getTypeId(var10, var11, var12);
                    int var14 = world.getData(var10, var11, var12);
                    if(canBreak(var13, var14) && attemptBreak(var1, var10, var11, var12))
                        scanBlockAndBreak(world, var2, var10, var11, var12);
                }
            }

        }

        ejectDropList(world, var2, var3, (double)var4 + 0.5D, var5);
    }
